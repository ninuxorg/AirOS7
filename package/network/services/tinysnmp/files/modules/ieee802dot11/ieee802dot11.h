...
static struct scTbl_data {
  ...
  char  stationID [ MACADDR_LEN ];                  // Default actual MacAddr
  ...
  char  disAssociationStation   [ MACADDR_LEN ];
  long  deAuthenticationReason;
  char  deAuthenticationStation [ MACADDR_LEN ];
  long  authenticateFailStatus;
  char  authenticateFailStation [ MACADDR_LEN ];
...
static struct kmTbl_data {
  ...
  char  WEPKeyMappingAddress  [ MACADDR_LEN ];
...
static struct riTbl_data {
  ...
  char  manufacturerOUI            [ MAN_OUI_LEN ];
